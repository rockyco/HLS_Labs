...
HD_PWD='D:/Projects/VivadoProj/UTS/PolyIntrpFilter/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PolyIntrpFilter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PolyIntrpFilter.tcl
