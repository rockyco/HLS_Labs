...
HD_PWD='D:/Projects/VivadoProj/UTS/PolyIntrpFilter/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PolyIntrpFilter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PolyIntrpFilter.tcl -notrace
