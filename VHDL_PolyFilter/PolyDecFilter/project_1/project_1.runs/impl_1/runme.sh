...
HD_PWD='D:/Projects/VivadoProj/UTS/PolyDecFilter/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PolyDecFilter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PolyDecFilter.tcl -notrace
