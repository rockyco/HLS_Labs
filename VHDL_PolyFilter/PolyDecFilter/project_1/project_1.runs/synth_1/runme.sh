...
HD_PWD='D:/Projects/VivadoProj/UTS/PolyDecFilter/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PolyDecFilter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PolyDecFilter.tcl
